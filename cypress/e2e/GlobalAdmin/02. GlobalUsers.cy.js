...
import GlobalUsers from "../../PageObjects/GlobalUsers.js";
...
describe('LoginToPaywat', () => {
    it('Global Admin Login and Navigate to Organizations List', () => {
        ...
        cy.fixture('paywatlogin.json').then((credentials) => {
            ...
            leftMenu.clickGlobalUsers();

            // Validate the Global Users
            const globalUsers = new GlobalUsers();
            globalUsers.verifyTitle();
            globalUsers.verifyUser01();
            globalUsers.verifyUser02();
